<?php 
/* ---------------------------------------------------------------------------
 * filename    : rating_create.php
 * author      : Kyle Sorenson
 * description : This file allows the user to create a restaurant rating.
 * ---------------------------------------------------------------------------
 */
      ...
      <div class="span10 offset1">
        ...
        <form class="form-horizontal" action="rating_create.php" method="post">
          ...
          <div class="control-group <?php echo !empty($reviewnameError)?'error':'';?>">
            <label class="control-label">Review Name
            </label>
            <div class="controls">
          ...
          <div class="form-actions">
            ...
            <a class="btn" href="rating.php">Back
            </a>
          </div>
        </form>
      </div>
