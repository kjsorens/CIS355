<?php 
/* ---------------------------------------------------------------------------
* filename    : rating_update.php
* author      : Kyle Sorenson
* description : This file allows a user to update their review.
* ---------------------------------------------------------------------------
*/	
      ...
      <div class="span10 offset1">
        ...
        <form class="form-horizontal" action="rating_update.php?id=<?php echo $id?>" method="post">
          ...
          <div class="control-group <?php echo !empty($reviewnameError)?'error':'';?>">
            <label class="control-label">Reviewer's Name
            </label>
            <div class="controls">
